...
if (isset($_POST['make'])) {
    ...
    if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_name']) || empty($_GET['prod_price'])) {
...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <!-- Header -->
        <div style="background-image: url(../admin/assets/img/theme/restro03.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <label>Product Name</label>
                                        ...
                                        ?>
                                            <input class="form-control" readonly name="prod_name" value="<?php echo $prod->prod_name; ?>">
                                        
                                        <label>Product Price (&#8377)</label>
                                            <input type="text" readonly name="prod_price" value="&#8377 <?php echo $prod->prod_price; ?>" class="form-control">
                                        <?php } ?>
                                    </div>
                                </div>
                                <hr>
                                ...
                                ?>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <select name="prod_qty" class="form-control">
