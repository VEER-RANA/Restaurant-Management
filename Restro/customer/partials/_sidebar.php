  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../admin/assets/img/brand/image.jpg" class="navbar-brand-img" alt="...">
      </a> -->
      <img src="../admin/assets/img/brand/image.jpg"  alt="LOGO">
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt='Image placeholder' src='../admin/assets/img/brand/image.jpg'>
              </span>
            </div>
          </a>
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard.php">
                <img src="../admin/assets/img/brand/image.jpg">
              </a>
            </div>
